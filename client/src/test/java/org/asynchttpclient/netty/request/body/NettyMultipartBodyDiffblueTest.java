...
class NettyMultipartBodyDiffblueTest {
   ...
   *
   * <p>Method under test: {@link NettyMultipartBody#NettyMultipartBody(List, HttpHeaders,
  ...
  void testNewNettyMultipartBody() throws UnsupportedEncodingException {
    ...
    // Act
    NettyMultipartBody actualNettyMultipartBody =
        new NettyMultipartBody(parts, new DefaultHttpHeaders(), mock(AsyncHttpClientConfig.class));

    // Assert
    assertTrue(actualNettyMultipartBody.getBody() instanceof MultipartBody);
  }
   ...
   */
  @Test
  @DisplayName("Test new NettyMultipartBody(List, HttpHeaders, AsyncHttpClientConfig); given 'A'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void NettyMultipartBody.<init>(List, HttpHeaders, AsyncHttpClientConfig)"})
  void testNewNettyMultipartBody_givenA() {
    // Arrange
    ArrayList<Part> parts = new ArrayList<>();
  ...
  @Test
  @DisplayName(
      "Test new NettyMultipartBody(List, HttpHeaders, AsyncHttpClientConfig); then return ContentLength is minus one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void NettyMultipartBody.<init>(List, HttpHeaders, AsyncHttpClientConfig)"})
  void testNewNettyMultipartBody_thenReturnContentLengthIsMinusOne()
   ...
   *   <li>Then Body return {@link MultipartBody}.
   * </ul>
   *
   * <p>Method under test: {@link NettyMultipartBody#NettyMultipartBody(List, HttpHeaders,
   * AsyncHttpClientConfig)}
  ...
  @Test
  @DisplayName(
      "Test new NettyMultipartBody(List, HttpHeaders, AsyncHttpClientConfig); when ArrayList(); then Body return MultipartBody")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void NettyMultipartBody.<init>(List, HttpHeaders, AsyncHttpClientConfig)"})
  ...
  /**
   * Test {@link NettyMultipartBody#getContentTypeOverride()}.
   *
   * <p>Method under test: {@link NettyMultipartBody#getContentTypeOverride()}
   */
  @Test
  @DisplayName("Test getContentTypeOverride()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"java.lang.String NettyMultipartBody.getContentTypeOverride()"})
  void testGetContentTypeOverride() {
    // Arrange
    HttpHeaders headers = mock(HttpHeaders.class);
    when(headers.get(Mockito.<CharSequence>any())).thenReturn("https://example.org/example");
    NettyMultipartBody nettyMultipartBody =
        new NettyMultipartBody(new ArrayList<>(), headers, mock(AsyncHttpClientConfig.class));
