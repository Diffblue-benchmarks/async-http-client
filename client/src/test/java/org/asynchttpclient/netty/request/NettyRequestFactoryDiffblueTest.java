...
class NettyRequestFactoryDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return HttpRequest Method name is {@code CONNECT}.
   * </ul>
   *
   * <p>Method under test: {@link NettyRequestFactory#newNettyRequest(Request, boolean, ProxyServer,
   * Realm, Realm)}
  ...
  @Test
  @DisplayName(
      "Test newNettyRequest(Request, boolean, ProxyServer, Realm, Realm); then return HttpRequest Method name is 'CONNECT'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "NettyRequest NettyRequestFactory.newNettyRequest(Request, boolean, ProxyServer, Realm, Realm)"
  })
  void testNewNettyRequest_thenReturnHttpRequestMethodNameIsConnect() {
    // Arrange
    AsyncHttpClientConfig config = mock(AsyncHttpClientConfig.class);
   ...
   *
   * <ul>
   *   <li>When {@link Request} {@link Request#getVirtualHost()} return {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link NettyRequestFactory#newNettyRequest(Request, boolean, ProxyServer,
   * Realm, Realm)}
  ...
  @Test
  @DisplayName(
      "Test newNettyRequest(Request, boolean, ProxyServer, Realm, Realm); when Request getVirtualHost() return 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "NettyRequest NettyRequestFactory.newNettyRequest(Request, boolean, ProxyServer, Realm, Realm)"
  })
  void testNewNettyRequest_whenRequestGetVirtualHostReturnNull() {
    // Arrange
    AsyncHttpClientConfig config = mock(AsyncHttpClientConfig.class);
    when(config.isKeepAlive()).thenReturn(true);
    when(config.getUserAgent()).thenReturn("https://example.org/example");
   ...
   * <ul>
   *   <li>When {@code true}.
   *   <li>Then return HttpRequest headers unwrap size is five.
   * </ul>
   *
   * <p>Method under test: {@link NettyRequestFactory#newNettyRequest(Request, boolean, ProxyServer,
   * Realm, Realm)}
  ...
  @Test
  @DisplayName(
      "Test newNettyRequest(Request, boolean, ProxyServer, Realm, Realm); when 'true'; then return HttpRequest headers unwrap size is five")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "NettyRequest NettyRequestFactory.newNettyRequest(Request, boolean, ProxyServer, Realm, Realm)"
  })
  void testNewNettyRequest_whenTrue_thenReturnHttpRequestHeadersUnwrapSizeIsFive() {
    // Arrange
    AsyncHttpClientConfig config = mock(AsyncHttpClientConfig.class);
    when(config.isKeepAlive()).thenReturn(true);
    when(config.getUserAgent()).thenReturn("https://example.org/example");
