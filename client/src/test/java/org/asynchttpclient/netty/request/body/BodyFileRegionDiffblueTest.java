...
class BodyFileRegionDiffblueTest {
   ...
   * <ul>
   *   <li>When one.</li>
   *   <li>Then {@link BodyFileRegion#BodyFileRegion(RandomAccessBody)} with body is {@link MultipartBody#MultipartBody(List, String, byte[])} refCnt is two.</li>
   * </ul>
   * <p>
   ...
   * <ul>
   *   <li>Given {@link MultipartBody} {@link MultipartBody#transferTo(WritableByteChannel)} return one.</li>
   *   <li>When {@code null}.</li>
   *   <li>Then return one.</li>
   * </ul>
   * <p>
   * Method under test: {@link BodyFileRegion#transferTo(WritableByteChannel, long)}
   */
  @Test
   ...
   * Test {@link BodyFileRegion#transferTo(WritableByteChannel, long)}.
   * <ul>
   *   <li>Given {@link MultipartBody} {@link MultipartBody#transferTo(WritableByteChannel)} return zero.</li>
   *   <li>When {@code null}.</li>
   ...
   * <ul>
   *   <li>Given {@link RandomAccessBody} {@link Closeable#close()} throw {@link ChannelClosedException#INSTANCE}.</li>
