...
class BodyFileRegionDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return transfered is zero.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test retain(int) with 'int'; when one; then BodyFileRegion(RandomAccessBody) with body is MultipartBody(List, String, byte[]) refCnt is two")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Given {@link MultipartBody} {@link MultipartBody#transferTo(WritableByteChannel)} return
   *       one.
   *   <li>When {@code null}.
   *   <li>Then return one.
   * </ul>
  ...
  @Test
  @DisplayName(
      "Test transferTo(WritableByteChannel, long); given MultipartBody transferTo(WritableByteChannel) return one; when 'null'; then return one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"long BodyFileRegion.transferTo(WritableByteChannel, long)"})
  void testTransferTo_givenMultipartBodyTransferToReturnOne_whenNull_thenReturnOne()
      throws IOException {
    // Arrange
  ...
  @Test
  @DisplayName(
      "Test transferTo(WritableByteChannel, long); given MultipartBody transferTo(WritableByteChannel) return zero; when 'null'; then return zero")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"long BodyFileRegion.transferTo(WritableByteChannel, long)"})
  void testTransferTo_givenMultipartBodyTransferToReturnZero_whenNull_thenReturnZero()
      throws IOException {
    // Arrange
    MultipartBody body = mock(MultipartBody.class);
   ...
   *   <li>Then calls {@link RandomAccessBody#close()}.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test deallocate(); given RandomAccessBody close() throw INSTANCE; then calls close()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
