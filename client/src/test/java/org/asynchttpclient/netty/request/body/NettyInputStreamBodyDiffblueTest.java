...
class NettyInputStreamBodyDiffblueTest {
  ...
  /**
   * Method under test:
   * {@link NettyInputStreamBody#write(Channel, NettyResponseFuture)}
   */
  @Test
  void testWrite() throws IOException {
    // Arrange
    NettyInputStreamBody nettyInputStreamBody = new NettyInputStreamBody(
    ...
    // Act
    nettyInputStreamBody.write(channel,
