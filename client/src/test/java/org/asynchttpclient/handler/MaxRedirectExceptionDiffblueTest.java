...
class MaxRedirectExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link MaxRedirectException#MaxRedirectException(String)}
   */
  @Test
  ...
  void testNewMaxRedirectException() {
    // Arrange and Act
    MaxRedirectException actualMaxRedirectException =
        new MaxRedirectException("https://example.org/example");
