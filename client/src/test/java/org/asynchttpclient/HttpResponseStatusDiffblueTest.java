...
class HttpResponseStatusDiffblueTest {
   ...
   *
   * <p>Method under test: {@link HttpResponseStatus#getUri()}
   */
  @Test
  @DisplayName("Test getUri()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Uri HttpResponseStatus.getUri()"})
  void testGetUri() {
    // Arrange
    Uri uri =
        new Uri(
    ...
    // Act and Assert
    assertSame(uri, nettyResponseStatus.getUri());
  }
   ...
   *
   * <ul>
   *   <li>Then return {@code 1 Unknown Status (1)}.
   * </ul>
   *
   * <p>Method under test: {@link HttpResponseStatus#toString()}
   */
  @Test
  @DisplayName("Test toString(); then return '1 Unknown Status (1)'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"java.lang.String HttpResponseStatus.toString()"})
  void testToString_thenReturn1UnknownStatus1() {
    ...
    // Act and Assert
    assertEquals("1 Unknown Status (1)", nettyResponseStatus.toString());
  }
}
