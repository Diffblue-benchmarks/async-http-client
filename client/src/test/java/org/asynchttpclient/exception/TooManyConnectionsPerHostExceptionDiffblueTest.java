...
class TooManyConnectionsPerHostExceptionDiffblueTest {
   ...
   * TooManyConnectionsPerHostException#TooManyConnectionsPerHostException(int)}
   */
  @Test
  ...
  void testNewTooManyConnectionsPerHostException() {
    // Arrange and Act
    TooManyConnectionsPerHostException actualTooManyConnectionsPerHostException =
        new TooManyConnectionsPerHostException(3);

    // Assert
    assertEquals(
        "Too many connections: 3", actualTooManyConnectionsPerHostException.getLocalizedMessage());
