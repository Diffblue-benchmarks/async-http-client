...
class TooManyConnectionsExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link TooManyConnectionsException#TooManyConnectionsException(int)}
   */
  @Test
  @DisplayName("Test new TooManyConnectionsException(int)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void TooManyConnectionsException.<init>(int)"})
  void testNewTooManyConnectionsException() {
    // Arrange and Act
    TooManyConnectionsException actualTooManyConnectionsException =
        new TooManyConnectionsException(3);

    // Assert
    assertEquals(
        "Too many connections: 3", actualTooManyConnectionsException.getLocalizedMessage());
