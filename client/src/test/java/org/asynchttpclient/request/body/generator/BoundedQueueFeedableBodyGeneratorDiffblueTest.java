...
class BoundedQueueFeedableBodyGeneratorDiffblueTest {
   ...
   * <p>
   * Method under test: {@link BoundedQueueFeedableBodyGenerator#BoundedQueueFeedableBodyGenerator(int)}
   */
  @Test
   ...
   * <ul>
   *   <li>Then {@link BoundedQueueFeedableBodyGenerator#BoundedQueueFeedableBodyGenerator(int)} with capacity is three {@link QueueBasedFeedableBodyGenerator#queue} size is one.</li>
   * </ul>
   * <p>
