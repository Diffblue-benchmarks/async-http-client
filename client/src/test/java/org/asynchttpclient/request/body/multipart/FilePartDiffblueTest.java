...
class FilePartDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link FilePart#FilePart(String, File, String)}
   */
  @Test
  @DisplayName("Test new FilePart(String, File, String); when Property is 'java.io.tmpdir' is 'foo' toFile")
  @Tag("MaintainedByDiffblue")
   ...
   * </ul>
   * <p>
   * Method under test: {@link FilePart#FilePart(String, File, String, Charset, String)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link FilePart#FilePart(String, File, String, Charset, String, String)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link FilePart#FilePart(String, File, String, Charset, String, String, String)}
   */
  @Test
   ...
   */
  @Test
  @DisplayName("Test new FilePart(String, File, String); when Property is 'java.io.tmpdir' is 'test.txt' toFile")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void FilePart.<init>(String, File, String)"})
