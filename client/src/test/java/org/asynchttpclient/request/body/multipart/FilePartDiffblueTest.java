...
class FilePartDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test new FilePart(String, File, String, Charset, String); when 'File Name'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void FilePart.<init>(String, File, String, Charset, String)"})
  void testNewFilePart_whenFileName() {
    // Arrange
    File file = Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile();
    ...
    assertThrows(
        ...
        () ->
            new FilePart(
                "https://example.org/example", file, null, Charset.forName("UTF-8"), "File Name"));
  }
   ...
   */
  @Test
  @DisplayName("Test new FilePart(String, File, String, Charset, String, String); when 'File Name'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void FilePart.<init>(String, File, String, Charset, String, String)"})
  void testNewFilePart_whenFileName2() {
    // Arrange
    File file = Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile();
  ...
  @Test
  @DisplayName(
      "Test new FilePart(String, File, String, Charset, String, String, String); when 'File Name'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void FilePart.<init>(String, File, String, Charset, String, String, String)"})
  void testNewFilePart_whenFileName3() {
    // Arrange
    File file = Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile();
   ...
   */
  @Test
  @DisplayName("Test new FilePart(String, File, String, Charset, String); when 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void FilePart.<init>(String, File, String, Charset, String)"})
  void testNewFilePart_whenNull() {
    // Arrange
    File file = Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void FilePart.<init>(String, File, String, Charset, String)"})
  void testNewFilePart_whenNull2() {
    // Arrange
    File file = Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void FilePart.<init>(String, File, String, Charset, String)"})
  void testNewFilePart_whenNull3() {
    // Arrange
    File file = Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile();
   ...
   */
  @Test
  @DisplayName("Test new FilePart(String, File, String, Charset, String, String); when 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void FilePart.<init>(String, File, String, Charset, String, String)"})
  void testNewFilePart_whenNull4() {
    // Arrange
    File file = Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void FilePart.<init>(String, File, String, Charset, String, String)"})
  void testNewFilePart_whenNull5() {
    // Arrange
    File file = Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void FilePart.<init>(String, File, String, Charset, String, String)"})
  void testNewFilePart_whenNull6() {
    // Arrange
    File file = Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile();
  ...
  @Test
  @DisplayName(
      "Test new FilePart(String, File, String, Charset, String, String, String); when 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void FilePart.<init>(String, File, String, Charset, String, String, String)"})
  void testNewFilePart_whenNull7() {
    // Arrange
    File file = Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void FilePart.<init>(String, File, String, Charset, String, String, String)"})
  void testNewFilePart_whenNull8() {
    // Arrange
    File file = Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void FilePart.<init>(String, File, String, Charset, String, String, String)"})
  void testNewFilePart_whenNull9() {
    // Arrange
    File file = Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile();
