...
class ChannelPoolPartitioningDiffblueTest {
  /**
   * Test CompositePartitionKey {@link CompositePartitionKey#equals(Object)}, and {@link
   * CompositePartitionKey#hashCode()}.
   *
   * <ul>
  ...
  @Test
  @DisplayName(
      "Test CompositePartitionKey equals(Object), and hashCode(); when other is equal; then return equal")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean CompositePartitionKey.equals(Object)",
    "int CompositePartitionKey.hashCode()"
  })
  void testCompositePartitionKeyEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    CompositePartitionKey compositePartitionKey =
        new CompositePartitionKey(
            "https://example.org/example",
            "https://example.org/example",
            "https://example.org/example",
            8080,
            ProxyType.HTTP);
    CompositePartitionKey compositePartitionKey2 =
        new CompositePartitionKey(
            "https://example.org/example",
            "https://example.org/example",
            "https://example.org/example",
    ...
    assertEquals(compositePartitionKey.hashCode(), compositePartitionKey2.hashCode());
  }
  ...
  @Test
  @DisplayName(
      "Test CompositePartitionKey equals(Object), and hashCode(); when other is same; then return equal")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean CompositePartitionKey.equals(Object)",
   ...
   * </ul>
   *
   * <p>Method under test: {@link CompositePartitionKey#equals(Object)}
   */
  @Test
  @DisplayName(
      "Test CompositePartitionKey equals(Object); when other is different; then return not equal")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean CompositePartitionKey.equals(Object)",
  ...
  @Test
  @DisplayName(
      "Test CompositePartitionKey equals(Object); when other is 'null'; then return not equal")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean CompositePartitionKey.equals(Object)",
  ...
  @Test
  @DisplayName(
      "Test CompositePartitionKey equals(Object); when other is wrong type; then return not equal")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean CompositePartitionKey.equals(Object)",
   ...
   *
   * <ul>
   *   <li>{@link CompositePartitionKey#CompositePartitionKey(String, String, String, int,
   *       ProxyType)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void CompositePartitionKey.<init>(String, String, String, int, ProxyType)",
    "String CompositePartitionKey.toString()"
  })
  void testCompositePartitionKeyGettersAndSetters() {
    // Arrange and Act
    CompositePartitionKey actualCompositePartitionKey =
        new CompositePartitionKey(
            "https://example.org/example",
            "https://example.org/example",
            "https://example.org/example",
    ...
    assertEquals(
        ...
        actualCompositePartitionKey.toString());
  }

  /**
   * Test PerHostChannelPoolPartitioning {@link PerHostChannelPoolPartitioning#getPartitionKey(Uri,
   * String, ProxyServer)}.
   *
   * <p>Method under test: {@link PerHostChannelPoolPartitioning#getPartitionKey(Uri, String,
   * ProxyServer)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Object PerHostChannelPoolPartitioning.getPartitionKey(Uri, String, ProxyServer)"
  })
  void testPerHostChannelPoolPartitioningGetPartitionKey() {
    ...
    // Act and Assert
    assertTrue(
        PerHostChannelPoolPartitioning.INSTANCE.getPartitionKey(
                uri,
                "https://example.org/example",
                new ProxyServer(
                    "https://example.org/example",
                    ...
                    new ArrayList<>(),
                    ProxyType.HTTP))
            instanceof CompositePartitionKey);
  }
  ...
  void testPerHostChannelPoolPartitioningGetPartitionKey2() {
    ...
    assertTrue(
        PerHostChannelPoolPartitioning.INSTANCE.getPartitionKey(
                uri, "https://example.org/example", null)
            instanceof CompositePartitionKey);
  }
}
