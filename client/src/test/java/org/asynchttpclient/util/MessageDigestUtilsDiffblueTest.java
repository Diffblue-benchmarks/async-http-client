...
class MessageDigestUtilsDiffblueTest {
   ...
   *
   * <p>Method under test: {@link MessageDigestUtils#pooledMd5MessageDigest()}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link MessageDigestUtils#pooledSha1MessageDigest()}
   */
  @Test
  ...
  void testPooledSha1MessageDigest() {
    // Arrange and Act
    MessageDigest actualPooledSha1MessageDigestResult =
        MessageDigestUtils.pooledSha1MessageDigest();
