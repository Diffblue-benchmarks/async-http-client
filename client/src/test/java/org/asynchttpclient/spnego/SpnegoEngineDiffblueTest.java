...
class SpnegoEngineDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test instance(String, String, String, String, boolean, Map, String); given 'Key'; when HashMap() 'Key' is '42'; then return LoginConfiguration Type is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "SpnegoEngine SpnegoEngine.instance(String, String, String, String, boolean, Map, String)"
  })
  void testInstance_givenKey_whenHashMapKeyIs42_thenReturnLoginConfigurationTypeIsNull() {
    // Arrange
    HashMap<String, String> customLoginConfig = new HashMap<>();
    customLoginConfig.put("Key", "42");
  ...
  void testInstance_whenHashMap_thenReturnLoginConfigurationIsNull2() {
    // Arrange and Act
    SpnegoEngine actualInstanceResult =
        SpnegoEngine.instance(
            "janedoe",
  ...
  @Test
  @DisplayName(
      "Test getLoginConfiguration(); given HashMap() 'Key' is '42'; then return Type is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Configuration SpnegoEngine.getLoginConfiguration()"})
  void testGetLoginConfiguration_givenHashMapKeyIs42_thenReturnTypeIsNull() {
    // Arrange
    HashMap<String, String> customLoginConfig = new HashMap<>();
    customLoginConfig.put("Key", "42");
    SpnegoEngine spnegoEngine =
