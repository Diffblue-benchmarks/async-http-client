...
class RealmDiffblueTest {
  ...
  @MethodsUnderTest({"Realm Builder.build()", "Builder Builder.setAlgorithm(String)",
      "Builder Builder.setCharset(Charset)", "Builder Builder.setCustomLoginConfig(Map)",
      "Builder Builder.setLoginContextName(String)", "Builder Builder.setMethodName(String)",
      "Builder Builder.setNc(String)", "Builder Builder.setNonce(String)", "Builder Builder.setNtlmDomain(String)",
      "Builder Builder.setNtlmHost(String)", "Builder Builder.setOmitQuery(boolean)",
      "Builder Builder.setOpaque(String)", "Builder Builder.setRealmName(String)",
      "Builder Builder.setResponse(String)", "Builder Builder.setScheme(AuthScheme)",
      "Builder Builder.setServicePrincipalName(String)", "Builder Builder.setUri(Uri)",
      "Builder Builder.setUseAbsoluteURI(boolean)", "Builder Builder.setUseCanonicalHostname(boolean)",
  ...
  void testBuilderNewBuilder() {
    ...
    Builder actualSetServicePrincipalNameResult = actualSetCharsetResult.setCustomLoginConfig(new HashMap<>())
    ...
    Builder actualSetUseCanonicalHostnameResult = actualSetServicePrincipalNameResult
   ...
   * <ul>
   *   <li>Given {@link Builder#Builder()} Nonce is empty string.</li>
   *   <li>When {@code null}.</li>
   * </ul>
   * <p>
   * Method under test: {@link Builder#parseProxyAuthenticateHeader(String)}
   */
  @Test
  @DisplayName("Test Builder parseProxyAuthenticateHeader(String); given Builder() Nonce is empty string; when 'null'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Builder Builder.parseProxyAuthenticateHeader(String)"})
  void testBuilderParseProxyAuthenticateHeader_givenBuilderNonceIsEmptyString_whenNull() {
    // Arrange
   ...
   * </ul>
   * <p>
   * Method under test: {@link Builder#parseWWWAuthenticateHeader(String)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link Builder#setQop(String)}
   */
  @Test
