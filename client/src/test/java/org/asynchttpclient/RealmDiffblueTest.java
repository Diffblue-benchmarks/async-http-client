...
class RealmDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link Builder#Builder()} Nonce is {@code null}.</li>
   ...
   */
  @Test
  @DisplayName("Test Builder parseProxyAuthenticateHeader(String); given Builder() Nonce is 'null'; when 'null'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Builder Builder.parseProxyAuthenticateHeader(String)"})
  void testBuilderParseProxyAuthenticateHeader_givenBuilderNonceIsNull_whenNull() {
    // Arrange
